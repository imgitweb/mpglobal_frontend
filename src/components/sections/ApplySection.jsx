...
const ApplySection = () => {
  ...
  const validateField = (name, value) => {
    ...
    if (name === "businessInfo.yearStarted" && value) {
                      ...
                      <div className="form-progress-steps">
                        {[
                          ...
                          <div
                            ...
                            onClick={async () => {
                              // Only allow moving forward if all previous sections are valid
                              let canMove = true;
                              ...
                              if (canMove) setActiveSection(index + 1);
                            }}
                          >
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                onChange={handleInputChange}
                                onBlur={handleBlur}
                                placeholder="10-digit mobile number (only number)"
                              />
                              {validationErrors["personalInfo.mobileNo"] && (
                                <div className="invalid-feedback">
                                  {validationErrors["personalInfo.mobileNo"]}
                          ...
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input
                                ...
                                className={`form-control ${validationErrors["businessInfo.yearStarted"] ? "is-invalid" : ""}`}
